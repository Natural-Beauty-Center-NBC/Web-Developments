...
@section('content')
<form id="save-form" class="p-8 my-6 mx-4 bg-white rounded-lg shadow" method="POST" action="{{ route('admin.store-perawatan') }}" enctype="multipart/form-data">
    @csrf
...
<script>
    function confirmSave() {
        Swal.fire({
            ...
            text: "Data Perawatan akan ditambahkan!",
            icon: 'warning',
