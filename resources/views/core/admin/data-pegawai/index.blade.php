...
<div class="p-4 my-6 mx-4 bg-white rounded-lg shadow md:flex flex-col md:p-6 xl:p-8 dark:bg-gray-800">
    <div class="w-full mb-1">
        ...
        <div class="flex flex-row justify-end gap-4 text-right mb-4">
            <div>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" id="dataTable">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b">
                    ...
                    <td class="px-6 py-4">
                        <div class="{{ $pegawai->status == 'Available' ? 'bg-green-500' : 'bg-red-500' }} text-white p-2 rounded-xl text-center font-bold">
                            {{ $pegawai->status }}
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex gap-4">
                            ...
                            <form action=" " method="POST">
                                @csrf
                                @method('DELETE')
                                <!-- Set unique modal trigger and modal ID -->
                                <button data-modal-target="popup-modal-{{ $pegawai->id }}" data-modal-toggle="popup-modal-{{ $pegawai->id }}"
                                    type="button"
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want
                                                    to delete?</h3>
                                                <button data-modal-hide="popup-modal-{{ $pegawai->id }}" type="submit"
                                                    class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                                    Yes, I'm sure
                                                </button>
                                                <button data-modal-hide="popup-modal-{{ $pegawai->id }}" type="button"
