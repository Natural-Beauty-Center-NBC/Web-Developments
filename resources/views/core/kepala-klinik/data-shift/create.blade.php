...
@section('content')
<form id="save-form" class="p-8 my-6 mx-4 bg-white rounded-lg shadow" method="POST" action="{{ route('kepala-klinik.store-shift') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="w-full flex flex-col gap-4">
        ...
        <div class="flex w-full justify-end">
            <a href="{{ route('kepala-klinik.index-shift') }}" class="w-1/4 text-center text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Cancel</a>
...
<script>
    function confirmSave() {
        Swal.fire({
            ...
            text: "Data Shift akan ditambahkan!",
            icon: 'warning',
