...
@section('content')
<form id="save-form" class="p-8 my-6 mx-4 bg-white rounded-lg shadow" method="POST" action="{{ route('dokter.input-produk') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="w-full flex flex-col gap-4">
        <div class="flex gap-4">
            ...
            <div class="flex-1">
                <label for="jumlah" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah Pembelian</label>
