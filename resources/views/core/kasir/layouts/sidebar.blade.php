        ...
        <ul class="space-y-2 font-normal">
            <li>
                <a href="{{ route('kasir.home') }}"
                    class="{{ $title == 'Kasir | Home' ? 'bg-[#FF9EAA] to-[#5038ED] text-white font-bold' : '' }} flex items-center text-[16px] hover:bg-[#FF9EAA] text-[#171717] hover:text-white hover:font-bold p-2 mb-4 rounded-lg">
