<x-guest-layout>
    ...
    <div class="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-xl dark:bg-gray-800">
        ...
        <form class="mt-8 space-y-6" method="POST" action="{{ route('login-staff.save') }}" enctype="multipart/form-data">
            @csrf
            <div>
            ...
            <div class="text-sm font-medium text-gray-500 dark:text-gray-400">
                Not registered yet? <a class="text-blue-700 hover:underline dark:text-blue-500"
                    href=" ">Contact Admin Please!</a>
            </div>
            <div class="text-sm font-medium text-gray-500 dark:text-gray-400">
                Are you customer? <a class="text-blue-700 hover:underline dark:text-blue-500"
